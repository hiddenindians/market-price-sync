...
export declare const configurationSchema: import('@sinclair/typebox').TIntersect<
  [
    import('@sinclair/typebox').TObject<{
      authentication: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
          secret: import('@sinclair/typebox').TString<string>
          entity: import('@sinclair/typebox').TOptional<
            import('@sinclair/typebox').TUnion<
              [import('@sinclair/typebox').TString<string>, import('@sinclair/typebox').TNull]
            >
          >
          ...
          parseStrategies: import('@sinclair/typebox').TOptional<
          ...
          local: import('@sinclair/typebox').TOptional<
            import('@sinclair/typebox').TObject<{
              ...
              entityUsernameField: import('@sinclair/typebox').TOptional<
                import('@sinclair/typebox').TString<string>
              >
              entityPasswordField: import('@sinclair/typebox').TOptional<
                import('@sinclair/typebox').TString<string>
              >
            }>
          >
          oauth: import('@sinclair/typebox').TOptional<
            import('@sinclair/typebox').TObject<{
              redirect: import('@sinclair/typebox').TOptional<import('@sinclair/typebox').TString<string>>
              origins: import('@sinclair/typebox').TOptional<
                import('@sinclair/typebox').TArray<import('@sinclair/typebox').TString<string>>
              >
              defaults: import('@sinclair/typebox').TOptional<
                import('@sinclair/typebox').TObject<{
      ...
      >
      paginate: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
      ...
      mysql: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
          client: import('@sinclair/typebox').TString<string>
          connection: import('@sinclair/typebox').TUnion<
            [
              import('@sinclair/typebox').TString<string>,
          ...
          >
          pool: import('@sinclair/typebox').TOptional<
            import('@sinclair/typebox').TObject<{
      ...
      >
      postgresql: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
          client: import('@sinclair/typebox').TString<string>
          connection: import('@sinclair/typebox').TUnion<
            [
      ...
      >
      sqlite: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
          client: import('@sinclair/typebox').TString<string>
          connection: import('@sinclair/typebox').TUnion<
            [
      ...
      >
      mssql: import('@sinclair/typebox').TOptional<
        import('@sinclair/typebox').TObject<{
          client: import('@sinclair/typebox').TString<string>
          connection: import('@sinclair/typebox').TUnion<
            [
