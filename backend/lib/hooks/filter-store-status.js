...
exports.filterStoreStatus = void 0;
const filterStoreStatus = async (context) => {
    ...
    if (result && storeId) {
        if (Array.isArray(result.data)) {
            ...
            context.result.data = result.data.map((product) => {
                ...
                if (!product.store_status[storeId]) {
                    ...
                    if (product.type === 'Single Cards') {
                        ...
                        product.store_status[storeId].moderately_played = {
                            selling: { enabled: false, quantity: 0 },
                            buying: { enabled: false, quantity: 0 }
                        };
                        product.store_status[storeId].heavily_played = {
                            selling: { enabled: false, quantity: 0 },
                            buying: { enabled: false, quantity: 0 }
                        };
                        product.store_status[storeId].damaged = {
                            selling: { enabled: false, quantity: 0 },
                            buying: { enabled: false, quantity: 0 }
                        };
                    }
...
exports.filterStoreStatus = filterStoreStatus;
//# sourceMappingURL=filter-store-status.js.map