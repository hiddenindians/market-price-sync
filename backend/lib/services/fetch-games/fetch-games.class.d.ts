...
export declare class FetchGamesService<ServiceParams extends FetchGamesParams = FetchGamesParams> implements ServiceInterface<FetchGames, FetchGamesData, ServiceParams, FetchGamesPatch> {
