...
import type { FetchGames, FetchGamesData, FetchGamesPatch, FetchGamesQuery, FetchGamesService } from './fetch-games.class';
export type { FetchGames, FetchGamesData, FetchGamesPatch, FetchGamesQuery };
export type FetchGamesClientService = Pick<FetchGamesService<Params<FetchGamesQuery>>, (typeof fetchGamesMethods)[number]>;
