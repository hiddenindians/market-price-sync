...
export declare const setsSchema: import("@sinclair/typebox").TObject<{
    ...
    store_status: import("@sinclair/typebox").TArray<import("@sinclair/typebox").TObject<{
...
export declare const setsDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    _id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    game_id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    name: import("@sinclair/typebox").TString<string>;
    external_id: import("@sinclair/typebox").TObject<{
...
export declare const setsPatchSchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    code: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
}>>]>;
...
export declare const setsQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    _id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    game_id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    name: import("@sinclair/typebox").TString<string>;
    external_id: import("@sinclair/typebox").TObject<{
...
export declare const setsQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TObject<{
