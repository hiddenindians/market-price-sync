...
export declare const gamesExternalResolver: import('@feathersjs/schema').Resolver<
  ...
  HookContext<GamesService<import('./games.class').GamesParams>>
>
export declare const gamesDataSchema: import('@sinclair/typebox').TPick<
...
export declare const gamesDataResolver: import('@feathersjs/schema').Resolver<
  ...
  HookContext<GamesService<import('./games.class').GamesParams>>
>
export declare const gamesPatchSchema: import('@sinclair/typebox').TPartial<
  import('@sinclair/typebox').TObject<{
    _id: import('@sinclair/typebox').TUnion<
      [import('@sinclair/typebox').TString<string>, import('@sinclair/typebox').TObject<{}>]
    >
...
export declare const gamesQuerySchema: import('@sinclair/typebox').TObject<{
  ...
  'external_id.tcgcsv_id': import('@sinclair/typebox').TOptional<
    ...
    >
  >
  enabled: import('@sinclair/typebox').TOptional<
    import('@sinclair/typebox').TUnion<
      [
          ...
          import('@sinclair/typebox').TIntersect<
            [
              import('@sinclair/typebox').TObject<{
                ...
                $in:
                  | import('@sinclair/typebox').TBoolean
                  | import('@sinclair/typebox').TArray<import('@sinclair/typebox').TBoolean>
                $nin:
                  | import('@sinclair/typebox').TBoolean
                  | import('@sinclair/typebox').TArray<import('@sinclair/typebox').TBoolean>
              }>,
