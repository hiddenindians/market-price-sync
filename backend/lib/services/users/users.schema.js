...
exports.userSchema = typebox_1.Type.Object({
    ...
    store_id: typebox_1.Type.Optional((0, typebox_2.ObjectIdSchema)()),
    role: typebox_1.Type.Optional(typebox_1.Type.Enum(Roles))
...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'username', 'store_id', 'role'], {
    $id: 'UserData'
});
