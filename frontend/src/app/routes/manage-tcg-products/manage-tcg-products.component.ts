...
export class ManageTCGProductsComponent implements OnInit {
  ...
  sets: any[] = []
  products: any[] = []
  displayedColumns: string[]  = ['store_status.selling.enabled','store_status.selling.quantity','name', 'collector_number', 'market_price', 'store_status.buying.enabled', 'store_status.buying.quantity']
  pageSize: number = 10;
  pageIndex: number = 0;
